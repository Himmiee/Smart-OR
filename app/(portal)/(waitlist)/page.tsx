...
const WaitlistPage = () => {
  return (
    <ContainerCard backgroundImg={img} alt="Grid background">
      <div className="flex flex-col md:flex-row w-full xl:mt-20 2xl:mt-34  items-stretch min-h-screen overflow-hidden bg xl:min-h-auto max-w-[1700px] mx-auto">
        ...
        <div className="hidden xl:flex items-end justify-center w-full xl:flex-1 order-first xl:order-last">
          <div className="relative w-full max-w-md md:max-w-lg xl:max-w-full">
            <Image
              src={heroimg}
              alt="SmartOR Hero"
